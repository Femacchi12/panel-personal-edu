(() => {
  ...
  function render(){
    ...
    if(!host){host=document.createElement('div');host.id='fxSensitivityPanel';host.className='panel fx-sensitivity';const converter=root.querySelector('.fx-panel:nth-of-type(2)');if(converter)converter.insertAdjacentElement('afterend',host);else root.appendChild(host);}
