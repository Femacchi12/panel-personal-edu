(() => {
  ...
  function renderFinancing(financing, currency, canonical) {
    ...
    const html = `<div class="kpi-card"><span class="kpi-label">Crédito · 1 pago</span><strong class="kpi-value">${formatMoney(financing.one, currency)}</strong><div class="kpi-meta"><span>Compras con crédito registradas en un solo pago</span></div></div><div class="kpi-card"><span class="kpi-label">Crédito · en cuotas</span><strong class="kpi-value gold">${formatMoney(financing.multi, currency)}</strong><div class="kpi-meta"><span>Cuotas del período de compras financiadas en 2 o más pagos</span></div></div><div class="kpi-card"><span class="kpi-label">Compras con crédito</span><strong class="kpi-value gold">${formatMoney(total, currency)}</strong><div class="kpi-meta"><span>${financing.count} compra${financing.count === 1 ? '' : 's'} · excluye pagos de tarjeta, manejo e intereses</span></div></div>`;
